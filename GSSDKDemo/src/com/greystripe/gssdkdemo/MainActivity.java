...
import com.greystripe.gssdkdemo.R;
import com.greystripe.sdk.*;

public class MainActivity extends Activity {
	private static final String LOG_TAG = "GSSDKDemo";
	...
	private class MyFullscreenListener implements GSAdListener {
		...
		public void onFetchedAd(GSAd ad) {
			...
			// Use ad.getId(); after fetch to retrieve the Greystripe Ad Id for debugging
			int id = ad.getId();
			String adid = Integer.toString(id);
			Log.v("Greystripe AdId", adid);
		}
